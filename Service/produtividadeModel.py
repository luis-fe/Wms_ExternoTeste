...
def ProdutividadeRepositores(dataInicial = '0', dataFInal ='0' , horarioInicial = '01:00:00', horarioFinal ='23:59:00'):
    ...
    if dataInicial == '0' and dataFInal == '0':
        ...
        ritmo2 = pd.read_sql(
            ...
            ' WHERE r.dia >= %s and r.dia <= %s and horario >= %s and horario <= %s', conn, params=(dataInicial, dataFInal,))
...
def RelatorioSeparacaoBI(empresa, dias):
...
def DetalhaRitmoRepositor(usuario, dataInicial, dataFInal):
    ...
    ritmo2 = pd.concat([ritmo2, ritmo2_2])
    ritmo2['intervalo'] = ritmo2['intervalo'].astype(str)
    ritmo2 = ritmo2.groupby(['usuario', 'dia', 'intervalo'])['ritmo'].sum().reset_index()
