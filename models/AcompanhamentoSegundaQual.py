...
def TagSegundaQualidade(iniVenda, finalVenda, origem):
    ...
    tags['nomeFaccicionista'] = tags.apply(lambda row: 'Avaliar Lavanderia'if row['nomeOrigem'] == 'LAVANDERIA' and row['nomeFaccicionista'] == '-'  else   row['nomeFaccicionista'], axis=1)
    ...
    if origem == '' or origem == '-':
        ...
        tags = tags[tags['nomeOrigem'] == origem]
