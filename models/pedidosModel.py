...
def InformacaoImpresao(pedido):
    ...
    pedido = pd.read_sql('select codigopedido, desc_cliente as cliente, codcliente, cod_usuario, cidade, estado, agrupamentopedido, prioridade from "Reposicao".filaseparacaopedidos f '
