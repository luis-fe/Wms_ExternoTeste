...
WHERE m.codEmpresa = %s and codTransacao = 1426
    ...
    query1 = sql.SQL('update  "Reposicao"."filareposicaoportag" set "status_fila" = "Devolucao" WHERE not in (select codbarrastag from "Reposicao".tagsreposicao) and codbarrastag IN ({})').format(
